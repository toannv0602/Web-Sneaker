<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AccountSortLoadControl.ascx.cs" Inherits="webSneakers.cms.admin.account.AccountSortLoadControl" %>
...
<%--Admin.aspx?modul=account&account=sortName--%>